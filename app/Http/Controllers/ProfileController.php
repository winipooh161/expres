...
class ProfileController extends Controller
{
    ...
    public function viewProfile($id)
    {
        ...
        // Проверяем, может ли текущий пользователь просматривать запрашиваемый профиль
        if (!$this->canViewProfile($viewer, $target)) {
            // Если доступ запрещен, перенаправляем на собственный профиль
            return redirect()->route('profile.index')->with('error', 'У вас нет доступа к просмотру этого профиля.');
        }
